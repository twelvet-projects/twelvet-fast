...
public class I18nController extends TWTController
{
    ...
    @SaCheckPermission("@role.hasPermi('system:i18n:export')")
    ...
    @SaCheckPermission("@role.hasPermi('system:i18n:query')")
    ...
    @SaCheckPermission("@role.hasPermi('system:i18n:add')")
    ...
    @SaCheckPermission("@role.hasPermi('system:i18n:edit')")
    ...
    @SaCheckPermission("@role.hasPermi('system:i18n:remove')")
